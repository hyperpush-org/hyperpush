...
- `bash scripts/verify-m049-s05.sh` — the assembled scaffold/examples-first verifier that replays the dual-db Todo scaffolds, committed `/examples` parity, proof-app retirement, and retained M048 tooling truth while keeping SQLite local, Postgres shared/deployable, and older clustered rails subordinate retained evidence
